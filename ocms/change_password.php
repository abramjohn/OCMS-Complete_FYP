...
<body background="image/engine-wallpaper-hd-21.jpg" class="respon-img" >
          ...
          <div class="col-4">
           ...
           <div class="col-lg-4 col-sm-12 animated bounceInDown" style="background:rgba(0,0,0,0.8)">
            ...
            <h3>Change Password</h3>
                ...
                <input type="password"  name="old_password" placeholder="Old Password" id="form_email" style="width: 90%"  aria-label="Username" aria-describedby="basic-addon1">
                </p>
