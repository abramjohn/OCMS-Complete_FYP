...
<body background="image/super_sports_cars-HD.jpg" class="respon-img">
 ...
 <div class="container">
        ...
        <div class="row">
            ...
            <h2>SELECT BRAND</h2>
                ...
                <form id="select_car_form" onsubmit="return brand()" action="checkdata.php" method="post" onSubmit="brand()">
                    <br>
                    ...
                    <input type="hidden" value="car" name="car"> 
                    <br>
                    <br>

                    
                    <input class="btn btn-success btn-block"  type="submit" name="add_car_brand" value="Go To Shop">
                    <br>
                </form>
            </div>
