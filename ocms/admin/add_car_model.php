...
if(isset($_POST['model']))
{
	...
	$query = "INSERT INTO models (car_model) VALUES ('{$car_model}')";
                ...
                <form  action="add_car_model.php" method="post">
                    <br>
                     <div class="form-group">
						<input type="text" placeholder="Car Model" class="form-control" name="car_model" >
						  <br>			  
					</div>
                    ...
                    <button type="submit" name="model" class="btn btn-success btn-block"  id="registration_form">Create Category</button>
                    <br><br>
                </form>
            </div>
