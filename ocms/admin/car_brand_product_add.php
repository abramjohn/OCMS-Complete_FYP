...
<div class="container rounded" style="margin-top: 320px; width: 20%; background:rgba(0,0,0,0.7);">
	<form action="delete_function.php" method="post">
						  ...
						  <br>
						  <select class="form-control" name="type" style="padding-left: 10px; margin: 0px;" requied>
								<option>Select Type</option>
								<option value="Car">Car</option>
								<option value="Jeep">Jeep</option>
							</select>
							<br>
						  <input class="btn btn-success btn-block" type="submit" name="brand_filter_pro" value="GET PRODUCTS">
                    	  <br>
	</form>
</div>
